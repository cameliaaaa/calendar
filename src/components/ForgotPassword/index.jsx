...
function ForgotPassword(props) {
  ...
  return (
    <div className="container-center-horizontal">
      <form
        className="forgotpassword animate-enter4 screen"
        name="form3"
        method="post"
      >
        <div className="overlap-group4-2">
          ...
          <div className="overlap-group2-4">
            <div className="form-2 border-1px-alto">
              ...
              <div className="account-recovery tahoma-bold-blueberry-35px">
                {accountRecovery}
              </div>
              ...
              <a href="" className="align-self-flex-start">
                <div className="signup-btn-2 smart-layers-pointers">
                  <div className="overlap-group-17">
                    ...
                    <div className="confirm tahoma-regular-normal-white-18px">
                      {confirm}
                    </div>
                  </div>
                </div>
            ...
            <div className="text-9 tahoma-regular-normal-dove-gray-17px">
              {text9}
            </div>
          </div>
          <div className="overlap-group3-3">
            ...
            <Link to="/homepage">
              <div className="text-10 smart-layers-pointers tahoma-bold-ebony-clay-35px">
                {text10}
              </div>
            </Link>
          </div>
