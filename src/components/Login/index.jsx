...
function Login(props) {
  ...
  return (
    <div className="container-center-horizontal">
      <form
        className="loginForm animate-enter2 screen"
        name="login"
        ...
        <div className="loginWholePage">
          ...
          <div className="insideLoginPageComponents">
            ...
            <div className="form border-1px-alto">
              <img
                className="agile-sprite-login_image"
                src={agilesprite}
                alt={""}
              />
              <div className="log-in-text tahoma-bold-blueberry-35px">
                {logIn}
              </div>
              ...
              <input
                className="login-btn smart-layers-pointers"
                value={login}
                type={"submit"}
              />
              <div className="flex-row">
                <Link to="/forgotpassword">
                  <div className="forgot-password tahoma-regular-normal-blueberry-17px">
                    {forgotPassword}
                  </div>
                </Link>
                <Link to="/signup">
                  <div className="sign-up-now tahoma-regular-normal-blueberry-17px">
                    {signUpNow}
                  </div>
                </Link>
              </div>
          ...
          <div className="loginPageHeaderBar">
            ...
            <Link to="/homepage">
              <div className="text-6 smart-layers-pointers tahoma-bold-ebony-clay-35px">
                {text6}
              </div>
            </Link>
          </div>
