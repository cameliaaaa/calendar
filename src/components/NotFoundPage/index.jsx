      ...
      <div className="not-found-page animate-enter screen">
        <div className="overlap-group2">
          ...
          <div className="x404-nf">
            ...
            <div className="text-1 tahoma-regular-normal-dove-gray-17px">
              {text1}
            </div>
            <Link to="/homepage">
              <div className="back-to-home-page smart-layers-pointers">
                {backToHomePage}
              </div>
            </Link>
          </div>
          <div className="overlap-group1">
                ...
                <Link to="/signup">
                  <div className="group-143614 smart-layers-pointers">
                    <div className="overlap-group">
                      ...
                      <div className="sign-up tahoma-regular-normal-un-mellow-yellow-22px">
                        {signUp}
                      </div>
                    </div>
                  </div>
            ...
            <Link to="/homepage">
              <div className="text-2 smart-layers-pointers tahoma-bold-ebony-clay-35px">
                {text2}
              </div>
            </Link>
          </div>
